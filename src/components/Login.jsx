  ...
  return (
    <div className="m-0 p-0 bg-rose-600 min-h-screen flex justify-center items-center">
     <div className="flex flex-col justify-center items-center py-6 px-10 border m-10 w-[450px] max-w-[90%] bg-pink-600 rounded-xl shadow-xl shadow-pink-300">
        ...
        <div className="w-full">
          <label className="m-2 block font-bold">Password</label>
          <input type="text" required="true" name="password" value={userdata.password} onChange={handleChange} className="border rounded-md px-3 py-2 bg-white w-full " placeholder="Enter your password"/>
        </div>
        <div>
